 ...
 */
final class Version20241127211638 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE library (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, bloc VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, contact VARCHAR(255) DEFAULT NULL, opening_hours VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reservation_cellule (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, telephone VARCHAR(20) NOT NULL, type VARCHAR(100) NOT NULL, reason LONGTEXT NOT NULL, created_at DATETIME NOT NULL, reserved_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE reclamation CHANGE email email VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE reservation_cellule');
        $this->addSql('DROP TABLE subscription');
        $this->addSql('ALTER TABLE reclamation CHANGE email email VARCHAR(255) DEFAULT NULL');
    }
}
